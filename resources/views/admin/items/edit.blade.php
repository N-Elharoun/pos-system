        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">@lang('trans.item_edit')</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('admin.items.update',$item->id) }}" method="POST" id="main-form" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            @if ($item->gallery)
                                <div style="margin-top: 10px;">
                                    <strong>@lang('trans.gallery'):</strong><br>
                            ...
                            @foreach($itemStatuses as $value => $label)
                                <div class="form-check">
                                    <input type="radio"
                                        ...
                                        name="status"
                                        value="{{ $value }}"
                                        @if(old('status', $item->status->value) == $value) checked @endif>
                            ...
                            @foreach($itemShows as $value => $label)
                                <div class="form-check">
                                    <input type="radio"
                                        ...
                                        value="{{ $value }}"
                                        @if(old('is_shown_in_store', $item->is_shown_in_store->value) == $value) checked @endif>
