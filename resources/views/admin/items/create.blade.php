                    ...
                    <form action="{{ route('admin.items.store') }}" method="POST" id="main-form" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                    ...
                                    class="form-control"
                                    rows="4"
                                    placeholder="@lang('trans.enter_description')">{{ old('description') }}</textarea>
                                @error('item_code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group">
                            <label for="minimum_stock">@lang('trans.m.stock')</label>
                            <input type="text" class="form-control @error('minimum_stock') is-invalid @enderror"
                            name="minimum_stock" id="minimum_stock" value='{{ old('minimum_stock') }}'
                            placeholder="@lang('trans.enter_minimum_stock')">
                            @error('minimum_stock')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
